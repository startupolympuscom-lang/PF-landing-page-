      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center lg:px-8">
        <Reveal>
          ...
          <p className="mx-auto mt-5 max-w-2xl text-warm-gray">
            Peerfit was founded in 2025 in Morocco and incubated at Startup Olympus. What
            started as a simple idea — it shouldn't be this hard to find someone to play
            with — has grown into a platform connecting athletes across 20+ sports,
            wherever they train.
          </p>
        </Reveal>
